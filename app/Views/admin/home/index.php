<div class="container">
        ...
        <div class="carousel-inner">
          ...
          <?php foreach ($data['anime'] as $anime) : ?>
            <div class="carousel-item <?= $i == 0 ? 'active' : ''; ?>">
              <a href="<?= BASEURL; ?>/anime/detail/<?= $anime['slug']; ?>">
  ...
  <div class="d-flex bg-primary">
    ...
    <div class="col text-end my-auto p-2">
      <a href="<?= BASEURL; ?>/anime/<?= $data['linkOngoing']['status_slug']; ?>" class="btn btn-light py-1 fw-bold">More</a>
    </div>
  </div>
    ...
    <?php foreach ($data['ongoing'] as $anime) : ?>
      <div class="col-lg-4 col-md-6 col-sm-12 g-4">
        <div class="card text-center">
          <a href="<?= BASEURL; ?>/anime/detail/<?= $anime['slug']; ?>" class="text-light img-wrapper">
  ...
  <div class="d-flex bg-primary mt-3">
    ...
    <div class="col text-end my-auto p-2">
      <a href="<?= BASEURL; ?>/anime/<?= $data['linkFinished']['status_slug']; ?>" class="btn btn-light py-1 fw-bold">More</a>
    </div>
  </div>
